                            ...
                            <h1><a>Form</a></h1>
                             ...
                             <#else>
                                <form id="form_9436" class="appnitro" method="post" action="./edit">
                                    ...
                                    <#if saying.id != -1>
                                        <h2>Edit new saying</h2>
                                    <#else>
                                        <h2>Add new saying</h2>
                                    </#if>
                                        <p></p>
                                        </div>						
                                    <ul >
                                        <div>
                                            <input name="id" class="element text medium" type="hidden" maxlength="255" value="${saying.id}"/> 
                                            </div>

                                        <li id="li_1" >
                                            <label class="description" for="element_1">Saying </label>
                                            <div>
                                                <input name="content" class="element text medium" type="text" maxlength="255" value="${saying.content}"/> 
                                                </div> 
                                            </li>
