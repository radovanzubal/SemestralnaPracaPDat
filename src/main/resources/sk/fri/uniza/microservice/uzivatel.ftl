   ...
   <body id="main_body" >
      ...
      <div id="form_container">
         ...
         <div class="form_description">
            <h2>Uzivatel detail:</h2>
            <p></p>
         </div>
         <h2>id: ${uzivatel.id}!</h2> 
         <h2>Uzivatel meno: ${uzivatel.meno}!</h2>
         <h2>Uzivatel heslo: ${uzivatel.heslo}!</h2>
      </div>
         <a href="/uzivatel/list"><i class="fas fa-th-list fa-3x"></i></a>
