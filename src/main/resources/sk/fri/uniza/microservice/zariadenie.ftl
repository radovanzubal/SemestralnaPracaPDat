   ...
   <body id="main_body" >
      ...
      <div id="form_container">
         ...
         <div class="form_description">
            <h2>Detail zariadenia:</h2>
            <p></p>
         </div>
         <h2>id: ${zariadenie.id}!</h2> 
         <h2>Senzor type: ${zariadenie.content}!</h2>
      </div>
         <a href="/zariadenie/list"><i class="fas fa-th-list fa-3x"></i></a>
