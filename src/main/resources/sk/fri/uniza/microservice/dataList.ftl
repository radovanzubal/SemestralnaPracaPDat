...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <#if !(data??)>
      <#assign data = {"id":-1,"hodnota":-1,"idZariadenia":-1}> 
      </#if>
   ...
   <body id="main_body" >
      ...
      <div id="form_container">
         ...
         <ul>
            <#items as data>
            <li><p>id zariadenia: ${data.idZariadenia}hodnota: ${data.hodnota} timestamp: ${data.getDateOfStart()} | <a href="/data/edit/${data.id}"><i class="fas fa-pencil-alt"></i></a> <a href="javascript:void(0);" onclick="deleteData(${data.id});"><i class="fas fa-trash-alt"></i></a></p></li>
            </#items>
         </ul>
         <#else>
         <p>No datas
